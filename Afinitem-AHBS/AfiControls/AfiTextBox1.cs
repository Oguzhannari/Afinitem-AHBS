...
namespace Sunum.AfiControls
{
	...
	public partial class AfiTextBox1 : UserControl
	{
		...
		private HorizontalAlignment konum = HorizontalAlignment.Left;
		public AfiTextBox1()
		{
			InitializeComponent();
		}
        ...
        [Category("RJ Code Advance")]
        public HorizontalAlignment Konum
        {
            get { return konum; }
            set
            {
				if (value == HorizontalAlignment.Right)
					konum = HorizontalAlignment.Right;
				if (value == HorizontalAlignment.Left)
					konum = HorizontalAlignment.Left;
				if (value == HorizontalAlignment.Center)
					konum = HorizontalAlignment.Center;
				textBox2.TextAlign = konum;
            }
        }
